    ...
    <div class="content">
        <div class="container">
            ...
            <div class="col-md-6 body-form">
                <form class="mb-5" id="contactForm" method="post" action="{{ route('storeComplain') }}">
                    @csrf
				<div class="row">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                ...
                                {!! Form::select('admin_department_id', $adminsDepartments, null, ['required','placeholder' => "قسم الشكوي"]) !!}
                                @error('admin_department_id')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                                </div>
                            </div>
                ...
                <div class="row">
                  <div class="col-md-12 form-group">
                    <textarea class="form-control" name="message" id="message" cols="30" rows="7" placeholder="محتوي الشكوي" Required></textarea>
                    @error('message')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                  </div>
